class ClouderaDirectorClient < Formula
  ...
  url "http://archive.cloudera.com/director/director/2/cloudera-director-client-2.5.0-director2.5.0.tar.gz"
  sha256 "056e17a70ae24672abdaa94f4ef2b4b54c5a35195003ac64030139dbd78edc05"
